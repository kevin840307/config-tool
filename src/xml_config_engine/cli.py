...
def main(argv: list[str] | None=None) -> int:
    ...
    if args.cmd=='compile-folder':
        r=XmlFolderCompiler().compile_folder(args.before_root,args.after_root,args.output_root,args.include_unchanged,not args.no_verify,args.layout,args.matched_files_only,parse_vars(args.var),args.variable_map_file,args.fab,args.env)
